...
void main() {
  ...
  test('cutoff and PEQ vectors exactly match captures', () {
    ...
    expect(() => Icp5FrameCodec.buildFilterCutoffWrite(1, 2000),
        throwsArgumentError);
    expect(() => Icp5FrameCodec.buildPeqBand1GainWrite(1, -1.0),
        throwsArgumentError);
  });
  ...
  test('only repository-proven Output Gain channel pair is enabled', () {
  ...
  test('handshake gates writes and failed restore activates shared STOP',
    ...
    expect((await transport.writeCapturedDelayCandidate(0, 1.0)).success,
        isFalse);
